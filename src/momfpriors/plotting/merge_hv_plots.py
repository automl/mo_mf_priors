...
if __name__ == "__main__":
    ...
    if args.from_yaml:
        ...
        args.tight_layout = yaml_config.get("tight_layout", True)
        args.wspace = yaml_config.get("wspace", 0.5)
    ...
    # Adjust spacing between subplots without tight layout
    if not args.tight_layout:
        fig_ov_rank.subplots_adjust(
            wspace=args.wspace,
        )
    ...
    # Default spacing if tight layout is used
