...
def create_plots(  # noqa: C901, PLR0912, PLR0915
    *,
    ...
    iterations and from a pandas Series
    ...
    for instance, instance_data in agg_data.items():
        ...
        # For plotting continuations
            ...
            if "PriMO" in instance or "NepsMOASHAPiBORW" in instance:
    ...
    y1 = y2 = comp_speedup["val"] if comp_speedup["val"] < primo_init["val"] else primo_init["val"]
...
def make_subplots(  # noqa: C901, PLR0912, PLR0913, PLR0915
    ...
    *,
    ...
    axs_ov_rank[0].set_xlabel("Full Evaluations", fontsize=ovrank_xylabelsize)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Plot Hypervolumes for the given iterations."
    )
    parser.add_argument(
        "--no_save", "-ns",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="Turn off legend for the plots. "
            ...
            "hv, ov_rank can be specified to turn off legend for specific plots."
    )
    parser.add_argument(
        "--plot_title", "-title",
        type=str,
