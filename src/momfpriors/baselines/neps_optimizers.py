...
class NepsPriMO_HV(NepsOptimizer):
    """The PriMO optimizer from NePS."""
...
class NepsPriMO_TS(NepsOptimizer):
    """The PriMO optimizer from NePS with Thompson Sampling Acquisition Function."""
    ...
    def __init__(
        ...
        **kwargs: Any,  # noqa: ARG002
        ...
        match problem.fidelities:
            case None:
                raise ValueError("NepsPriMO_TS requires a fidelity.")
            case Mapping():
                raise NotImplementedError("Many-fidelity not yet implemented for NepsPriMO_TS.")
            case (fid_name, fidelity):
                _fid = (fid_name, fidelity)
            case _:
                raise TypeError("Fidelity must be a tuple or a Mapping.")
...
class NepsPriMO_LCB(NepsOptimizer):
    """The PriMO optimizer from NePS with LCB Acquisition Function."""
    ...
    def __init__(
        ...
        **kwargs: Any,  # noqa: ARG002
        ...
        match problem.fidelities:
            case None:
                raise ValueError("NepsPriMO_LCB requires a fidelity.")
            case Mapping():
                raise NotImplementedError("Many-fidelity not yet implemented for NepsPriMO_LCB.")
            case (fid_name, fidelity):
                _fid = (fid_name, fidelity)
            case _:
                raise TypeError("Fidelity must be a tuple or a Mapping.")
