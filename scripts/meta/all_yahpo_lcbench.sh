...
#SBATCH --job-name all_yahpo_lcbench            #  short: -J all_yahpo_lcbench
...
python3 -m momfpriors.run -y configs/exp_configs/all_yahpo_lcbench.yaml -e "all_ids_yahpo_lcbench_25"
