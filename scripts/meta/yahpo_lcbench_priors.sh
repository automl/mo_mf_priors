...
#SBATCH --job-name yahpo-lcbench_priors            #  short: -J yahpo-lcbench_priors
...
python3 -m momfpriors.generate_priors -y configs/prior_gen/all_yahpo_lcbench_ids.yaml -n 100000
